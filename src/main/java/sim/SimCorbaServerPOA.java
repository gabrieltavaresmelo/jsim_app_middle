 ...
 implements sim.SimCorbaServerOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("startRadar", new java.lang.Integer (4));
    _methods.put ("stopRadar", new java.lang.Integer (5));
    _methods.put ("changeLocation", new java.lang.Integer (6));
    _methods.put ("listNearlyClients", new java.lang.Integer (7));
    _methods.put ("addRoom", new java.lang.Integer (8));
    _methods.put ("getRoom", new java.lang.Integer (9));
    _methods.put ("listRooms", new java.lang.Integer (10));
    _methods.put ("changeClientRoom", new java.lang.Integer (11));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 4:  // sim/SimCorbaServer/startRadar
       {
         String nickname = in.read_string ();
       ...
       case 5:  // sim/SimCorbaServer/stopRadar
       {
         String nickname = in.read_string ();
       ...
       case 6:  // sim/SimCorbaServer/changeLocation
       {
         String nickname = in.read_string ();
         String location = in.read_string ();
         String $result = null;
       ...
       case 7:  // sim/SimCorbaServer/listNearlyClients
       {
         String nickname = in.read_string ();
         String $result = null;
       ...
       case 8:  // sim/SimCorbaServer/addRoom
       {
         String roomName = in.read_string ();
         String $result = null;
         $result = this.addRoom (roomName);
         out = $rh.createReply();
         out.write_string ($result);
         break;
       }

       case 9:  // sim/SimCorbaServer/getRoom
       {
         String clientName = in.read_string ();
         String $result = null;
         $result = this.getRoom (clientName);
         out = $rh.createReply();
         out.write_string ($result);
         break;
       }

       case 10:  // sim/SimCorbaServer/listRooms
       {
         String $result = null;
       ...
       case 11:  // sim/SimCorbaServer/changeClientRoom
       {
         String clientName = in.read_string ();
         String roomName = in.read_string ();
         String $result = null;
         $result = this.changeClientRoom (clientName, roomName);
         out = $rh.createReply();
         out.write_string ($result);
         break;
       }
